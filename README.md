...
Recent updates:
- v0.94: visual link editing treats `#fragment` links as internal links, the custom snippet dropdown is labeled as custom sections, imported CSS rules are scanned for section classes, WPM visual preview resolves supported Jinja macros while hiding unresolved legacy template syntax, and rendered section includes round-trip back to their original include directives.
...
- 0.94: Visual link editing now treats `#fragment` links as internal links, the custom snippet dropdown is labeled as custom sections, imported CSS rules are scanned for section classes, WPM visual preview resolves supported Jinja macros while hiding unresolved legacy template syntax, and rendered section includes round-trip back to their original include directives.
